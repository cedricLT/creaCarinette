<!--page d un item crochet ou tricot-->
<?php ob_start(); ?>
<?php $donner = $getCrochet ?>

<?php
if ($donner['categorie'] === 'crochet'){ ?>

    <h1 class="h1Title">Creations Crochet</h1>
<?php
}else { ?>
    <h1 class="h1Title">Creations Tricot</h1>
    <?php
}
?>
...
<div class="commentDropUsers">
    ...
    <form action="index.php?action=commentItem&idItem=<?= htmlspecialchars($donner['idItem']) ?>"
          method="post">
        <table>
            <tr>
                <td>
        ...
        <div class="row">
            <div class="tbn col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="report">
                    ...
                    <button>
                        <a
                                href="index.php?action=reportCommentItem&idItem=<?= $child['idItem'] ?>&idPost=<?= $child['idPost'] ?>#ancre">Signaler
                            ce commentaire</a>
                    </button>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="index.php?action=reponseCommentItem&idItem=<?= $child['idItem'] ?>&idPostParent=<?= $child['idPost'] ?>"
                              method="post">
