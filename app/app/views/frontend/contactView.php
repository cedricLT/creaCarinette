                        ...
                        <tr>
                            <td>
                                <div class="nomInput">
                                    ...
                                    <input required type="text" class="nom" name="name"
                        ...
                        <tr>
                            <td>
                                <div class="emailInput">
                                    ...
                                    <input required type="text" id="mail" class="email" name="email"
                                           onsubmit="verifMail(this)"
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="messageT ">
                                    ...
                                    <textarea required class="messageTexte" name="message" placeholder="Votre méssage"></textarea>
                                </div>
