...
while ($report = $reportCom->fetch()) {
    ...
    <div class="commentairesArticle">
        ...
        <div class="btnDelete">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?= $report['idPost'] ?>">
                supprimer ce commentaire
            </button>
        </div>

        <!-- Modal -->
        <div class="modal fade" id="exampleModal<?= $report['idPost'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
